...
class TutorLiveStreamPage extends StatefulWidget {
  ...
  final String token = "007eJxTYPCYLOWa3Wub5bX2+eS8nwf00z0XrY2yUn6euYhjqom3u7ICQ6qFqVFaooWFSUqakYmZcZqFcbKxmYVJUlKiiYGhhaVZVmtcekMgI8MBnixmRgYIBPF5GEpSi0vikzMS8/JScxgYAKQ4IBo=";

  TutorLiveStreamPage({Key? key}) : super(key: key);
    ...
    try {
      ...
      _engine.registerEventHandler(RtcEngineEventHandler(
        onJoinChannelSuccess: (connection, elapsed) {
          ...
          print('Tutor joined channel: ${connection.channelId} with UID: ${connection.localUid}');
          _startRtmpStream();
        },
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            TextButton(
              onPressed: () {
                // Even if "Cancel" is pressed, we still end the meeting.
                Navigator.of(context).pop();
                _quitMeeting();
              },
            ...
            TextButton(
              onPressed: () {
                // Handle the feedback if needed
                print('Tutor Feedback: $feedbackText');
                Navigator.of(context).pop();
                _quitMeeting();
              },
